...
/* MOD-980921 [HD]: Made Transform_Polygon accessible from outside. */
void Transform_Polygon PARAMS((OBJECT *Object, TRANSFORM *Trans));
static void Invert_Polygon PARAMS((OBJECT *Object));
static void Destroy_Polygon PARAMS((OBJECT *Object));
/* MOD-980921 [HD]: Made Compute_Polygon_BBox accessible from outside. */
void Compute_Polygon_BBox PARAMS((POLYGON *Polyg));
...
void Transform_Polygon(Object, Trans)
OBJECT *Object;
TRANSFORM *Trans;
{
  VECTOR N;
...
void Compute_Polygon_BBox(Polyg)
POLYGON *Polyg;
{
  int i;
