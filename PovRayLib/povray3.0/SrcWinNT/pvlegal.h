char *povlegal_text [] =
{
  ...
  "VERSION 2.x BUT MUST RE-APPLY FOR VERSION 3.00 OR LATER.",
  "",
  ...
  " ",
  "All of this software is Copyright 1991,1997 by the POV-Ray Team(tm).  ",
  ...
  "A \"full package\" consists of either:",
  "",
  ...
  "                                  - or -",
  "",
  "      2) Programmer archives containing full source code but no executable.  ",
  "         Also you must include an archive containing documentation, and",
  "         sample scenes.  On some platforms, the documentation and sample",
  ...
  "Intel x86 series; Apple Macintosh; Apple PowerPC; SunOS; and Amiga.  Other ",
  "systems may be added in the future.",
  "",
  "Distributors need not support all platforms but for each platform you ",
  "support you must distribute a full package.  For example a Macintosh only ",
  ...
  "program unless it is clearly a custom version of POV-Ray that includes all ",
  ...
  "support for your custom version.  The POV-Ray Team is not obligated to ",
  "provide you or your users any technical support.",
  "",
  ...
  "Team, but the team is in no way required to utilize these enhancements ",
  "or fixes.  By sending material to the team, the contributor asserts that ",
  "he owns the materials or has the right to distribute these materials.  ",
  "He authorizes the team to use the materials any way they like.  The ",
  "contributor still retains rights to the donated material, but by donating, ",
  "grants unrestricted, irrevocable usage and distribution rights to the ",
  "POV-Ray Team. The team doesn't have to use the material, but if we do, ",
  "you do not acquire any rights related to POV-Ray.  The team will give you ",
  ...
  "Ray through your product.  The POV-Ray Team is not obligated to provide ",
  "you or your customers any technical support.",
  ...
  "",
  "Although POV-Ray is, when distributed within the terms of this agreement,",
  "free of charge, the retail value (or price) of this program is determined",
  "as US$20.00 per copy distributed, copied, or used. If the software is",
  "distributed, copied, or used without authorisation you are legally liable",
  "to this debt to the copyright holder or any other person or organisation",
  ...
  "",
  "Put simply, POV-Ray is only free if you comply with our conditions ; it is not",
  "free otherwise. The copyright holder of this software chooses to give it away",
  "free under these and only these conditions.",
  "",
  "For the purpose of copyright regulations, the retail value of this software is",
  "US$20.00 per copy. In the case of online or remote execution, each instance of",
  "such online or remote execution is considered the same as distributing the",
  "program.",
  "",
  "                             OTHER PROVISIONS",
  "",
  ...
  "tends to imply it is a product of the POV-Ray Team.  Existing programs ",
  "which used \"POV\" prior to the publication of this document need ",
  ...
  "Team in violation the license which was in effect at the time.  There",
  "is evidence that other Future Publishing companies have also violated",
  "our terms.  Therefore \"PC Format\", and any other magazine, book or CD-ROM",
  "publication owned by Future Publishing is expressly prohibited from any",
  "distribution of POV-Ray software until further notice.",
  "",
  "",
  "                                DISCLAIMER",
  "",
  ...
  "the CompuServe Information Service in the GO POVRAY forum or check us out ",
  "on the internet at http://www.povray.org or ftp.povray.org.  The USENET ",
  "group comp.graphics.rendering.raytracing is a great source of information on ",
  "POV-Ray and related topics.",
  "",
